...
namespace CRUD {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(string LastName, string FirstName, string Address, string Contact, string Email) {
...
namespace CRUD.CustomerDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([Id] = @Original_Id) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([LastName], [FirstName], [Address], [Contact], [Ema" +
                "il]) VALUES (@LastName, @FirstName, @Address, @Contact, @Email);\r\nSELECT Id, Las" +
                "tName, FirstName, Address, Contact, Email FROM Customer WHERE (Id = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [LastName] = @LastName, [FirstName] = @FirstName, [Address] = @Address, [Contact] = @Contact, [Email] = @Email WHERE (([Id] = @Original_Id) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT Id, LastName, FirstName, Address, Contact, Email FROM Customer WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, LastName, FirstName, Address, Contact, Email FROM dbo.Customer";
        ...
        public virtual int Delete(int Original_Id, string Original_LastName, string Original_FirstName, string Original_Address, string Original_Contact, string Original_Email) {
        ...
        public virtual int Insert(string LastName, string FirstName, string Address, string Contact, string Email) {
            if ((LastName == null)) {
        ...
        public virtual int Update(string LastName, string FirstName, string Address, string Contact, string Email, int Original_Id, string Original_LastName, string Original_FirstName, string Original_Address, string Original_Contact, string Original_Email, int Id) {
            if ((LastName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string FirstName, string Address, string Contact, string Email, int Original_Id, string Original_LastName, string Original_FirstName, string Original_Address, string Original_Contact, string Original_Email) {
            return this.Update(LastName, FirstName, Address, Contact, Email, Original_Id, Original_LastName, Original_FirstName, Original_Address, Original_Contact, Original_Email, Original_Id);
        }
    }
